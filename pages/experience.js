      ...
      <div className={styles.timeline}>
        ...
        <div className={styles.job}>
          ...
          <ul className={styles.jobDescription}>
            <li>Conception et développement d&#39ERP, sites web et applications mobiles (React.js, Node.js, Flutter, React Native, PHP, Next.js).</li>
            ...
            <li>Mise en place de solutions d&#39intégration réduisant les temps d&#39arrêt.</li>
          </ul>
        </div>
        ...
        <div className={styles.job}>
          ...
          <ul className={styles.jobDescription}>
            <li>Développement complet d&#39applications web (Django, Angular, Spring Boot).</li>
            <li>Optimisation CI/CD avec GitHub, Jenkins, Docker (-30% temps déploiement).</li>
            <li>Réduction des temps d&#39arrêt grâce à une supervision efficace.</li>
          </ul>
        </div>
        ...
        <div className={styles.job}>
          ...
          <ul className={styles.jobDescription}>
            <li>Projet complet : site web + application mobile (React.js, React Native) avec +40% d&#39engagement utilisateur.</li>
        ...
        <div className={styles.job}>
          ...
          <ul className={styles.jobDescription}>
            <li>Conception d&#39un CRM pour call center (+20% de productivité).</li>
        ...
        <div className={styles.job}>
          ...
          <ul className={styles.jobDescription}>
            <li>Analyse des besoins + développement d&#39une appli PHP pour recherche de stages en ligne.</li>
          </ul>
        </div>
